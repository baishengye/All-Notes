...
import com.example.layoutanimationsdemo.databinding.ActivitySecondBinding;
...
public class SecondActivity extends AppCompatActivity {
    ...
    private void initTransition() {
        ...
        binding.parent.setLayoutTransition(mTransitioner);
    }
    ...
    private void setTransition() {
        ...
        mTransitioner.setAnimator(LayoutTransition.APPEARING, animator1);//不需要指定View,只要是在ViewGroup中出现的View都会使用这个动画
        ...
        final ObjectAnimator changeIn = ObjectAnimator.ofPropertyValuesHolder(
                        binding.parent, /*pvhLeft, pvhTop, pvhRight, pvhBottom,*/ animator3).
        ...
        final ObjectAnimator changeOut = ObjectAnimator.ofPropertyValuesHolder(
                        binding.parent, /*pvhLeft, pvhTop, pvhRight, pvhBottom,*/ pvhRotation).
    ...
    private void addButtonView() {
        ...
        binding.parent.addView(button, i, params);

    }

    private void removeButtonView() {
        if (i > 0)
            binding.parent.removeViewAt(0);
    }
}