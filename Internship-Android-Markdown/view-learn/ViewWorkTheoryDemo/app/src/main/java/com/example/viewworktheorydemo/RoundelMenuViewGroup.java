 ...
 */
public class RoundelMenuViewGroup extends ViewGroup {
    ...
    public RoundelMenuViewGroup(Context context) {
        this(context, null);
    }

    public RoundelMenuViewGroup(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundelMenuViewGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }


    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RoundelMenuViewGroup(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(context, attrs);
    }

    private void handleStyleable(Context context, AttributeSet attrs){
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RoundelMenuViewGroup);
        collapsedRadius = ta.getDimensionPixelSize(R.styleable.RoundelMenuViewGroup_round_menu_collapsedRadius, dp2px(22));
        expandedRadius = ta.getDimensionPixelSize(R.styleable.RoundelMenuViewGroup_round_menu_expandedRadius, dp2px(84));
        mRoundColor = ta.getColor(R.styleable.RoundelMenuViewGroup_round_menu_roundColor, Color.parseColor("#ffffbb33"));
        mCenterColor = ta.getColor(R.styleable.RoundelMenuViewGroup_round_menu_centerColor, Color.parseColor("#ffff8800"));
        mDuration = ta.getInteger(R.styleable.RoundelMenuViewGroup_round_menu_duration, 400);
        mItemAnimIntervalTime = ta.getInteger(R.styleable.RoundelMenuViewGroup_round_menu_item_anim_delay, 50);
        mItemWidth = ta.getDimensionPixelSize(R.styleable.RoundelMenuViewGroup_round_menu_item_width, dp2px(22));
        ta.recycle();
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        center = new Point();
        mCenterDrawable = getResources().getDrawable(R.drawable.ic_launcher_foreground,null);
